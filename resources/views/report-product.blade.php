    ...
    <div>
        <nav class="navbar bg-dark navbar-dark">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="/report-productWise">Daily Product Wise Report</a>
              </li>
              <li class="nav-item">
...
function myFunction() {
  ...
  document.body.innerHTML = backup;
          ...
          <div class='container float-left'>
            <form method="POST" action="{{ url('/report-daily-product') }}" class="row">
              @csrf
              <input  type="date" class="form-control col-md-3" style="margin:20px" id="date" name="date">
