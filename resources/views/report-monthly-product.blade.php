...
<div class="row" style="padding:30px;">
    <div>
        <nav class="navbar bg-dark navbar-dark">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="/report-monthly-product">Monthly Product Wise Report</a>
              </li>
              <li class="nav-item">
    ...
    <div class="col-md-10" >
        ...
        <h1>{{$title}}  { {{date("F",strtotime($time))}}  {{date("Y",strtotime($time))}} }</h1>      
          </div>
...
function myFunction() {
  ...
  document.body.innerHTML = backup;
          ...
          <div class='container float-left'>
            <form method="POST" action="{{ url('report-monthly-product-specific') }}" class="row">
              @csrf
              <input  type="month" class="form-control col-md-3" style="margin:20px" id="date" name="date">
